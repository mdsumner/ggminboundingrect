...
You can install ggminboundingrect from [CRAN](https://github.com/mdsumner/ggminboundingrect) with:
...
Thanks to Thomas Pedersen for awesome ggplot2-exteding guides (https://ggplot2-book.org/spring1.html). 
